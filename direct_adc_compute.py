...
############ Compute t2_2 ##############################
    ...
    if (direct_adc.method == "adc(2)-e" or direct_adc.method == "adc(3)"):
        ...
        temp_1 = np.einsum('bkjc,ikac->ijab',v2e_voov_ab,t2_1_ab) 
        ...
        temp_1 = np.einsum('kbcj,kica->ijab',v2e_ovvo_ab,t2_1_ab) 
        ...
        t2_2_ab += np.einsum('kbcj,kica->ijab',v2e_ovvo_ab,t2_1_a) 
        t2_2_ab += np.einsum('bkjc,ikac->ijab',v2e_voov_b,t2_1_ab) 
...
############ Compute t1_3 ##############################
    ...
    if (direct_adc.method == "adc(3)"):
        ...
        #t1_3_b -=     np.einsum('lmad,lmid->ia',t2_2_ab,v2e_ooov_ab,optimize=True)
        ...
        #t1_3_b += np.einsum('ilde,alde->ia',t2_2_ab,v2e_vovv_ab,optimize=True)
        ...
        #t1_3_b += np.einsum('ilfd,aefm,mled->ia',t2_1_ab,v2e_vvvo_b,t2_1_ab,optimize=True)
        ...
        #t1_3_b -= np.einsum('ildf,aemf,mlde->ia',t2_1_ab,v2e_vvov_ab,t2_1_ab,optimize=True)
        ...
        #t1_3_a += np.einsum('ilaf,defm,lmde->ia',t2_1_ab,v2e_vvvo_ab,t2_1_ab,optimize=True)
        ...
        #t1_3_b += 0.5*np.einsum('ilaf,defm,lmde->ia',t2_1_ab,v2e_vvvo_a,t2_1_a,optimize=True)
        t1_3_b += 0.5*np.einsum('lifa,defm,lmde->ia',t2_1_ab,v2e_vvvo_a,t2_1_a,optimize=True)
        #t1_3_b += np.einsum('ilaf,defm,lmde->ia',t2_1_ab,v2e_vvvo_ab,t2_1_ab,optimize=True)
        t1_3_b += np.einsum('lifa,defm,lmde->ia',t2_1_ab,v2e_vvvo_ab,t2_1_ab,optimize=True)
        #t1_3_b += np.einsum('ilaf,defm,lmde->ia',t2_1_b,v2e_vvvo_ab,t2_1_ab,optimize=True)
        ...
        #t1_3_b += np.einsum('inde,anlm,lmde->ia',t2_1_ab,v2e_vooo_ab,t2_1_ab,optimize=True)
        ...
        #t1_3_b -= 0.5 * np.einsum('inad,neml,mlde->ia',t2_1_b,v2e_ovoo_ab,t2_1_ab,optimize=True)
        t1_3_b -= 0.5 * np.einsum('inad,enml,mled->ia',t2_1_b,v2e_vooo_ab,t2_1_ab,optimize=True)
        #t1_3_b -= 0.5 * np.einsum('inad,nelm,lmde->ia',t2_1_b,v2e_ovoo_ab,t2_1_ab,optimize=True)
        t1_3_b -= 0.5 * np.einsum('inad,enlm,lmed->ia',t2_1_b,v2e_vooo_ab,t2_1_ab,optimize=True)
        #t1_3_b -= 0.5 *np.einsum('inad,enlm,lmed->ia',t2_1_ab,v2e_vooo_ab,t2_1_ab,optimize=True)
        t1_3_b -= 0.5 *np.einsum('nida,nelm,lmde->ia',t2_1_ab,v2e_ovoo_ab,t2_1_ab,optimize=True)
        #t1_3_b -= 0.5*np.einsum('inad,enml,mled->ia',t2_1_ab,v2e_vooo_ab,t2_1_ab,optimize=True)
        t1_3_b -= 0.5*np.einsum('nida,neml,mlde->ia',t2_1_ab,v2e_ovoo_ab,t2_1_ab,optimize=True)
        #t1_3_b += 0.5*np.einsum('inad,enlm,lmde->ia',t2_1_ab,v2e_vooo_a,t2_1_a,optimize=True)
        ...
        #t1_3_a -= np.einsum('lnde,amin,lmde->ia',t2_1_ab,v2e_vooo_a,t2_1_ab,optimize=True)
        ...
        #t1_3_b -= 0.5*np.einsum('lnde,amin,lmde->ia',t2_1_a,v2e_vooo_ab,t2_1_a,optimize=True)
        t1_3_b -= 0.5*np.einsum('lnde,mani,lmde->ia',t2_1_a,v2e_ovoo_ab,t2_1_a,optimize=True)
        #t1_3_b -= np.einsum('lnde,amin,lmde->ia',t2_1_ab,v2e_vooo_ab,t2_1_ab,optimize=True)
        ...
        #t1_3_a += np.einsum('lmdf,afie,lmde->ia',t2_1_ab,v2e_vvov_a,t2_1_ab,optimize=True)
        ...
        #t1_3_b += 0.5*np.einsum('lmdf,afie,lmde->ia',t2_1_a,v2e_vvov_ab,t2_1_a,optimize=True)
        t1_3_b += 0.5*np.einsum('lmdf,faei,lmde->ia',t2_1_a,v2e_vvvo_ab,t2_1_a,optimize=True)
        #t1_3_b += np.einsum('lmdf,afie,lmde->ia',t2_1_ab,v2e_vvov_ab,t2_1_ab,optimize=True)
        ...
        #t1_3_b += np.einsum('lnde,mein,lmad->ia',t2_1_ab,v2e_ovoo_ab,t2_1_b,optimize=True)
        t1_3_b += np.einsum('nled,emni,lmad->ia',t2_1_ab,v2e_vooo_ab,t2_1_b,optimize=True)
        #t1_3_b += np.einsum('nled,emin,mlad->ia',t2_1_ab,v2e_vooo_b,t2_1_ab,optimize=True)
        t1_3_b += np.einsum('lnde,emin,lmda->ia',t2_1_ab,v2e_vooo_b,t2_1_ab,optimize=True)
        #t1_3_b += np.einsum('lned,emin,lmad->ia',t2_1_ab,v2e_vooo_ab,t2_1_ab,optimize=True)
        t1_3_b += np.einsum('nlde,meni,mlda->ia',t2_1_ab,v2e_ovoo_ab,t2_1_ab,optimize=True)
        #t1_3_b -= np.einsum('lnde,mein,mlad->ia',t2_1_a,v2e_ovoo_ab,t2_1_ab,optimize=True)
        ...
        #t1_3_b -= np.einsum('lmef,efid,lmad->ia',t2_1_ab,v2e_vvov_ab,t2_1_ab,optimize=True)
...
######## ADC(2) part  ############################################
        ...
        if orb < nocc_b:
            ...
            T[s_b:f_b] -= 0.25*np.einsum('klc,klac->a',t2_1_ab[:,:,(orb-nocc_b),:], t2_1_ab, optimize = True)
            T[s_b:f_b] -= 0.25*np.einsum('lkc,lkac->a',t2_1_ab[:,:,(orb-nocc_b),:], t2_1_ab, optimize = True)
...
######### ADC(2) 1p part  ############################################
        ...
        if(method=='adc(3)'):
            ...
            if orb < nocc_b:
                ...
                T[s_b:f_b] -= 0.5*np.einsum('kac,ck->a',t2_1_ab[orb,:,:,:], t1_2_a.T,optimize = True)

                T[s_b:f_b] -= t1_3_a[orb,:]

            else:
               
                T[s_b:f_b] -= 0.25*np.einsum('klc,klac->a',t2_1_b[:,:,(orb-nocc_b),:], t2_2_b, optimize = True)
                T[s_b:f_b] -= 0.25*np.einsum('klc,klac->a',t2_1_ab[:,:,(orb-nocc_b),:], t2_2_ab, optimize = True)
                T[s_b:f_b] -= 0.25*np.einsum('lkc,lkac->a',t2_1_ab[:,:,(orb-nocc_b),:], t2_2_ab, optimize = True)

                T[s_b:f_b] -= 0.25*np.einsum('klac,klc->a',t2_1_b, t2_2_b[:,:,(orb-nocc_b),:],optimize = True) 
                T[s_b:f_b] -= 0.25*np.einsum('klac,klc->a',t2_1_ab, t2_2_ab[:,:,(orb-nocc_b),:],optimize = True) 
                T[s_b:f_b] -= 0.25*np.einsum('lkac,lkc->a',t2_1_ab, t2_2_ab[:,:,(orb-nocc_b),:],optimize = True) 
...
def get_Mij(direct_adc,t_amp):
    ...
    if (method == "adc(3)"):
        ...
        M_ij_b +=  np.einsum('d,lied,ljed->ij',e_vir_b,t2_1_ab, t2_2_ab)
        ...
        M_ij_b +=  np.einsum('d,ljed,lied->ij',e_vir_b,t2_1_ab, t2_2_ab)
        ...
        M_ij_b -= 0.5*np.einsum('l,lied,ljed->ij',e_occ_a,t2_1_ab, t2_2_ab)
        #M_ij_b -= 0.5*np.einsum('l,ilde,jlde->ij',e_occ_a,t2_1_ab, t2_2_ab)
        M_ij_b -= 0.5*np.einsum('l,lied,ljed->ij',e_occ_a,t2_1_ab, t2_2_ab)
        ...
        M_ij_b -= 0.5*np.einsum('l,ljed,lied->ij',e_occ_a,t2_1_ab, t2_2_ab)
        #M_ij_b -= 0.5*np.einsum('l,jlde,ilde->ij',e_occ_a,t2_1_ab, t2_2_ab)
        M_ij_b -= 0.5*np.einsum('l,ljed,lied->ij',e_occ_a,t2_1_ab, t2_2_ab)
        ...
        M_ij_b -= 0.25 *  np.einsum('i,lied,ljed->ij',e_occ_b,t2_1_ab, t2_2_ab)
        #M_ij_b -= 0.25 *  np.einsum('i,ilde,jlde->ij',e_occ_b,t2_1_ab, t2_2_ab)
        M_ij_b -= 0.25 *  np.einsum('i,lied,ljed->ij',e_occ_b,t2_1_ab, t2_2_ab)
        ...
        M_ij_b -= 0.25 *  np.einsum('i,ljed,lied->ij',e_occ_b,t2_1_ab, t2_2_ab)
        #M_ij_b -= 0.25 *  np.einsum('i,jlde,ilde->ij',e_occ_b,t2_1_ab, t2_2_ab)
        M_ij_b -= 0.25 *  np.einsum('i,ljed,lied->ij',e_occ_b,t2_1_ab, t2_2_ab)
        ...
        M_ij_b -= 0.25 *  np.einsum('j,ljed,lied->ij',e_occ_b,t2_1_ab, t2_2_ab)
        #M_ij_b -= 0.25 *  np.einsum('j,jlde,ilde->ij',e_occ_b,t2_1_ab, t2_2_ab)
        M_ij_b -= 0.25 *  np.einsum('j,ljed,lied->ij',e_occ_b,t2_1_ab, t2_2_ab)
        ...
        M_ij_b -= 0.25 *  np.einsum('j,lied,ljed->ij',e_occ_b,t2_1_ab, t2_2_ab)
        #M_ij_b -= 0.25 *  np.einsum('j,ilde,jlde->ij',e_occ_b,t2_1_ab, t2_2_ab)
        M_ij_b -= 0.25 *  np.einsum('j,lied,ljed->ij',e_occ_b,t2_1_ab, t2_2_ab)
...
def get_Mab(direct_adc,t_amp):
   ...
   # Second-order terms
    ...
    M_ab_b +=  np.einsum('l,lmad,lmbd->ab',e_occ_b,t2_1_ab, t2_1_ab)
    ...
    M_ab_b -= 0.5 *  np.einsum('d,lmad,lmbd->ab',e_vir_a,t2_1_ab, t2_1_ab)
    ...
    M_ab_b -= 0.25 *  np.einsum('a,lmad,lmbd->ab',e_vir_b,t2_1_a, t2_1_a)
    M_ab_b -= 0.25 *  np.einsum('a,lmad,lmbd->ab',e_vir_b,t2_1_ab, t2_1_ab)
    ...
    M_ab_b -= 0.25 *  np.einsum('b,lmad,lmbd->ab',e_vir_b,t2_1_ab, t2_1_ab)
    ...
    M_ab_b -=        np.einsum('lmad,lmbd->ab',t2_1_ab, v2e_oovv_ab)
    ...
    M_ab_b -=        np.einsum('lmbd,lmad->ab',t2_1_ab, v2e_oovv_ab)
    ...
    if(method =='adc(3)'):
        ...
        M_ab_b +=  np.einsum('ld,albd->ab',t1_2_a, v2e_vovv_ab)
        ...
        M_ab_b += np.einsum('ld,adbl->ab',t1_2_a, v2e_vvvo_ab)
        ...
        M_ab_b -= np.einsum('lmbd,lmad->ab',t2_2_ab,v2e_oovv_ab)
        ...
        M_ab_b -= np.einsum('lmad,lmbd->ab',t2_2_ab,v2e_oovv_ab)
        ...
        M_ab_b += np.einsum('l,lmbd,lmad->ab',e_occ_b, t2_1_ab, t2_2_ab, optimize=True)
        ...
        M_ab_b += np.einsum('l,lmad,lmbd->ab',e_occ_a, t2_1_a, t2_2_a, optimize=True)
        M_ab_b += np.einsum('l,lmad,lmbd->ab',e_occ_a, t2_1_ab, t2_2_ab, optimize=True)
        M_ab_b += np.einsum('l,lmda,lmdb->ab',e_occ_b, t2_1_ab, t2_2_ab, optimize=True)
        ...
        M_ab_b -= 0.5*np.einsum('d,lmbd,lmad->ab', e_vir_a, t2_1_ab ,t2_2_ab, optimize=True)
        ...
        M_ab_b -= 0.5*np.einsum('d,lmad,lmbd->ab', e_vir_a, t2_1_ab, t2_2_ab, optimize=True)
        ...
        M_ab_b -= 0.25*np.einsum('a,lmbd,lmad->ab',e_vir_b, t2_1_a, t2_2_a, optimize=True)
        M_ab_b -= 0.25*np.einsum('a,lmbd,lmad->ab',e_vir_b, t2_1_ab, t2_2_ab, optimize=True)
        ...
        M_ab_b -= 0.25*np.einsum('a,lmad,lmbd->ab',e_vir_b, t2_1_a, t2_2_a, optimize=True)
        M_ab_b -= 0.25*np.einsum('a,lmad,lmbd->ab',e_vir_b, t2_1_ab, t2_2_ab, optimize=True)
        ...
        M_ab_b -= 0.25*np.einsum('b,lmbd,lmad->ab',e_vir_b, t2_1_ab, t2_2_ab, optimize=True)
        ...
        M_ab_b -= 0.25*np.einsum('b,lmad,lmbd->ab',e_vir_b, t2_1_a, t2_2_a, optimize=True)
        M_ab_b -= 0.25*np.einsum('b,lmad,lmbd->ab',e_vir_b, t2_1_ab, t2_2_ab, optimize=True)
        ...
        M_ab_b += np.einsum('nled,mlbd,anem->ab',t2_1_ab, t2_1_ab, v2e_vovo_b, optimize=True)
        M_ab_b -= np.einsum('lnde,mlbd,anme->ab',t2_1_ab, t2_1_b, v2e_voov_ab, optimize=True)
        M_ab_b += np.einsum('lned,mlbd,anme->ab',t2_1_a, t2_1_ab, v2e_voov_ab, optimize=True)
        M_ab_b += np.einsum('lned,lmbd,anem->ab',t2_1_ab, t2_1_ab, v2e_vovo_ab, optimize=True)
        ...
        M_ab_a += np.einsum('mled,lnad,nebm->ab',t2_1_ab, t2_1_a, v2e_ovvo_ab, optimize=True)
        ...
        M_ab_b += np.einsum('mled,lnda,enbm->ab',t2_1_ab, t2_1_ab, v2e_vovo_b, optimize=True)
        M_ab_b += np.einsum('mled,lnad,enmb->ab',t2_1_ab, t2_1_b, v2e_voov_ab, optimize=True)
        M_ab_b += np.einsum('mlde,lnad,enbm->ab',t2_1_ab, t2_1_ab, v2e_vovo_ab, optimize=True)
        ...
        M_ab_a += np.einsum('mlbd,nlae,dnem->ab',t2_1_ab, t2_1_ab, v2e_vovo_ab, optimize=True)
 
        M_ab_b -= np.einsum('mlbd,lnae,dnem->ab',t2_1_b, t2_1_b, v2e_vovo_b, optimize=True)
        M_ab_b += np.einsum('lmbd,lnae,dnem->ab',t2_1_ab, t2_1_ab, v2e_vovo_a, optimize=True)
        M_ab_b += np.einsum('mlbd,lnae,dnme->ab',t2_1_b, t2_1_ab, v2e_voov_ab, optimize=True)
        M_ab_b -= np.einsum('lmbd,lnae,ndem->ab',t2_1_ab, t2_1_b, v2e_ovvo_ab, optimize=True)
        M_ab_b += np.einsum('mlbd,nlae,dnem->ab',t2_1_ab, t2_1_ab, v2e_vovo_ab, optimize=True)
        ...
        M_ab_b -= np.einsum('mlef,mlbd,adef->ab',t2_1_ab, t2_1_ab, v2e_vvvv_ab, optimize=True)
        ...
        M_ab_b -= np.einsum('mled,mlaf,edbf->ab',t2_1_ab, t2_1_ab, v2e_vvvv_ab, optimize=True)
        ...
        M_ab_b -= np.einsum('mlbd,noad,noml->ab',t2_1_ab, t2_1_ab, v2e_oooo_ab, optimize=True)
        ...
        M_ab_a -= np.einsum('lnde,mled,anbm->ab',t2_1_ab, t2_1_ab, v2e_vovo_ab, optimize=True)
        ...
        M_ab_b += 0.5*np.einsum('lned,mled,anbm->ab',t2_1_a, t2_1_a, v2e_vovo_ab, optimize=True)
        M_ab_b -= np.einsum('lnde,mled,anbm->ab',t2_1_ab, t2_1_ab, v2e_vovo_ab, optimize=True)
        M_ab_b -= np.einsum('nled,mled,anbm->ab',t2_1_ab, t2_1_ab, v2e_vovo_b, optimize=True)
        ...
        M_ab_a += np.einsum('lmdf,mled,aebf->ab',t2_1_ab, t2_1_ab, v2e_vvvv_ab, optimize=True)
        M_ab_a += np.einsum('mldf,lmed,aebf->ab',t2_1_ab, t2_1_ab, v2e_vvvv_a, optimize=True)
        
        M_ab_b -= 0.5*np.einsum('mldf,mled,aebf->ab',t2_1_b, t2_1_b, v2e_vvvv_b, optimize=True)
        M_ab_b -= 0.5*np.einsum('mldf,mled,aebf->ab',t2_1_a, t2_1_a, v2e_vvvv_ab, optimize=True)
        M_ab_b += np.einsum('lmdf,mled,aebf->ab',t2_1_ab, t2_1_ab, v2e_vvvv_ab, optimize=True)
        M_ab_b += np.einsum('mldf,lmed,aebf->ab',t2_1_ab, t2_1_ab, v2e_vvvv_b, optimize=True)
...
############ ADC(2) a - ibc block #########################
        ...
        s[s_b:f_b] += np.einsum('aibc,ibc->a', v2e_vovv_ab, r_aba, optimize = True)
...
############### ADC(2) ibc - a block ############################
        ...
        s[s_aba:f_aba] += np.einsum('aibc,a->ibc', v2e_vovv_ab, r_b, optimize = True).reshape(-1)
...
############### ADC(3) iab - jcd block ############################
        ...
        if (method == "adc(2)-e" or method == "adc(3)"):
               ...
               s[s_bab:f_bab] += np.einsum('yxwz,izw->ixy',v2e_vvvv_ab,r_bab,optimize = True).reshape(-1)
               ...
               temp +=0.5* np.einsum('yjiz,jxz->ixy',v2e_voov_ab,r_aba,optimize = True)
               s[s_bbb:f_bbb] += temp[:,ab_ind_b[0],ab_ind_b[1]].reshape(-1)    
               ...
               temp -= 0.5*np.einsum('xjiz,jyz->ixy',v2e_voov_ab,r_aba,optimize = True)

               s[s_bbb:f_bbb] += temp[:,ab_ind_b[0],ab_ind_b[1]].reshape(-1)             

               s[s_aba:f_aba] -= 0.5*np.einsum('xjzi,jzy->ixy',v2e_vovo_ab,r_aba,optimize = True).reshape(-1)
               ...
               temp -= 0.5*np.einsum('xjiw,jyw->ixy',v2e_voov_ab,r_aba,optimize = True)

               s[s_bbb:f_bbb] += temp[:,ab_ind_b[0],ab_ind_b[1]].reshape(-1)             

               s[s_aba:f_aba] -= 0.5*np.einsum('xjwi,jwy->ixy',v2e_vovo_ab,r_aba,optimize = True).reshape(-1)
               ...
               s[s_bab:f_bab] += 0.5*np.einsum('yjiw,jxw->ixy',v2e_voov_ab,r_aaa_u,optimize = True).reshape(-1)
               ...
               temp += 0.5*np.einsum('yjiw,jxw->ixy',v2e_voov_ab,r_aba,optimize = True)
...
############### ADC(3) a - ibc block ############################
               ...
               temp += np.einsum('jlwd,jzw->lzd',t2_1_ab,r_bab,optimize=True)
               ...
               temp_2 = np.einsum('jldw,jwz->lzd',t2_1_ab,r_bab)
               ...
               s[s_a:f_a] -= 0.5*np.einsum('lzd,zlda->a',temp_2,v2e_vovv_ab,optimize=True)
               ...
               if direct_adc.algorithm == "dynamical":
                   ...
                   temp_1 = np.zeros_like(r_aba)
               temp_1 = np.einsum('jlwd,jzw->lzd',t2_1_ab,r_bbb_u,optimize=True)
               ...
               s[s_b:f_b] += 0.5*np.einsum('lzd,zlad->a',temp_1,v2e_vovv_ab,optimize=True)
               ...
               temp += -np.einsum('jlzd,jwz->lwd',t2_1_ab,r_bab,optimize=True)
               ...
               temp_2 = -np.einsum('jldz,jzw->lwd',t2_1_ab,r_bab,optimize=True)
               ...
               s[s_a:f_a] += 0.5*np.einsum('lwd,wlda->a',temp_2,v2e_vovv_ab,optimize=True)
               ...
               if direct_adc.algorithm == "dynamical":
                   ...
                   temp_1 = np.zeros_like(r_bab)
               temp_1 = -np.einsum('jlzd,jwz->lwd',t2_1_ab,r_bbb_u,optimize=True)
               ...
               s[s_b:f_b] -= 0.5*np.einsum('lwd,wlad->a',temp_1,v2e_vovv_ab,optimize=True)
...
############### ADC(3) ibc - a block ############################
               ...
               temp_1 = np.einsum('xlbd,b->lxd', v2e_vovv_a,r_a)
               temp_2 = np.einsum('xlbd,b->lxd', v2e_vovv_ab,r_a)
              
               temp  = np.einsum('lxd,ilyd->ixy',temp_1,t2_1_a)
               temp += np.einsum('lxd,ilyd->ixy',temp_2,t2_1_ab)

               s[s_aaa:f_aaa] += temp[:,ab_ind_a[0],ab_ind_a[1] ].reshape(-1)
               
               temp  = np.einsum('lxd,ilyd->ixy',temp_1,t2_1_ab)
               temp  += np.einsum('lxd,ilyd->ixy',temp_2,t2_1_b)

               s[s_bab:f_bab] += temp.reshape(-1)

               temp_1 = np.einsum('xlbd,b->lxd', v2e_vovv_b,r_b)
               temp_2 = np.einsum('xlbd,b->lxd', v2e_vovv_ab,r_b)
              
               temp  = np.einsum('lxd,ilyd->ixy',temp_1,t2_1_b)
               temp += np.einsum('lxd,ilyd->ixy',temp_2,t2_1_ab)

               s[s_bbb:f_bbb] += temp[:,ab_ind_b[0],ab_ind_b[1] ].reshape(-1)
              
               temp  = np.einsum('lxd,ilyd->ixy',temp_1,t2_1_ab)
               temp  += np.einsum('lxd,ilyd->ixy',temp_2,t2_1_a)

               s[s_aba:f_aba] += temp.reshape(-1)

               temp_1 = np.einsum('ylbd,b->lyd', v2e_vovv_a,r_a)
               temp_2 = np.einsum('ylbd,b->lyd', v2e_vovv_ab,r_a)
              
               temp  = np.einsum('lyd,ilxd->ixy',temp_1,t2_1_a)
               temp += np.einsum('lyd,ilxd->ixy',temp_2,t2_1_ab)

               s[s_aaa:f_aaa] -= temp[:,ab_ind_a[0],ab_ind_a[1] ].reshape(-1)

               temp  = -np.einsum('lybd,b->lyd',v2e_ovvv_ab,r_a)
               temp_1= -np.einsum('lyd,lixd->ixy',temp,t2_1_ab)

               s[s_bab:f_bab] -= temp_1.reshape(-1)

               temp_1 = np.einsum('ylbd,b->lyd', v2e_vovv_b,r_b)
               temp_2 = np.einsum('ylbd,b->lyd', v2e_vovv_ab,r_b)
              
               temp  = np.einsum('lyd,ilxd->ixy',temp_1,t2_1_b)
               temp += np.einsum('lyd,ilxd->ixy',temp_2,t2_1_ab)

               s[s_bbb:f_bbb] -= temp[:,ab_ind_b[0],ab_ind_b[1] ].reshape(-1)
              
               temp  = -np.einsum('lybd,b->lyd',v2e_ovvv_ab,r_b)
               temp_1= -np.einsum('lyd,lixd->ixy',temp,t2_1_ab)
